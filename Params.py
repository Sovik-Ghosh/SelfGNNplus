...
def parse_args():
	...
	parser.add_argument('--ssl', default=False, type=bool, help='use self-supervised learning')
	...
	parser.add_argument('--ssldim', default=128, type=int, help='user weight embedding size')
